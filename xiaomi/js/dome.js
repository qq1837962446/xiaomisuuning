...
//选项卡
    ...
    nav_word.mouseenter(function () {
        $(this).children(".nav_xuan").animate({height:229,overflow:"none",borderTop: "1px solid #E0E0E0"},500);
    });
    nav_word.mouseleave(function () {
        $(this).children(".nav_xuan").animate({height:0,overflow:"hidden",borderTop:"none"},500);
    });
    let nav = $(".nav_box");
